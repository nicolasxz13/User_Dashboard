        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientMessageId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => x.MessageId);
                    table.ForeignKey(
                        name: "FK_Messages_Users_RecipientMessageId",
                        column: x => x.RecipientMessageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_RecipientMessageId",
                table: "Messages",
                column: "RecipientMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_UserMessageId",
                table: "Messages",
